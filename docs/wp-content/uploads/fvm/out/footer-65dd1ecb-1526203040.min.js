...
if(ev.originalEvent!==undefined&&!($.contains($box,$target)&&$target.is('input'))&&!$box.hasClass('spu-top-bar')&&!$box.hasClass('spu-bottom-bar')){toggleBox(id,!1,!1)}});$('body').on(event,'.spu-box,.spu-clickable',function(event){event.stopPropagation()});$box.hide().css('left','').css('right','');$boxes[id]=$box;var triggerHeightCheck=function()
...
{var box_id=jQuery('.spu-gogl').data('box-id');if(box_id){SPU.hide(box_id,!1,!0)}}}
